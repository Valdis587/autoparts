...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php printf( '<div class="cart"><a href="#" class="shipping-calculator-button btn buttonGray">%s</a></div>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
	...
	<section class="shipping-calculator-form" style="display:none;">
        ...
        <div class="cart"><p><button type="submit" name="calc_shipping" value="1" class="button btn buttonGray"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p></div>
