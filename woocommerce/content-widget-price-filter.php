...
<form style="margin-top: 30px; margin-bottom: 30px" method="get" action="<?php echo esc_url( $form_action ); ?>">
	<div class="price_slider_wrapper">
		...
		<div class="price_slider_amount" data-step="<?php echo esc_attr( $step ); ?>">
            ...
            <div class="cart">
			<button type="submit" class="button btn buttonGray main-filter-but"><?php echo esc_html__( 'Filter', 'woocommerce' ); ?></button>
            </div>
