...
function estore_woocommerce_custom_checkout_billing_fields( $address_fields, $country ) {
    ...
    $address_fields['billing_city']['class']      = array( 'row col-md-4' );
    $address_fields['billing_state']['class']     = array( 'row col-md-4' );
    $address_fields['billing_postcode']['class']  = array( 'row col-md-4' );
    $address_fields['billing_phone']['class']     = array( 'row col-md-4' );
    $address_fields['billing_email']['class']     = array( 'row col-md-4 ' );
