...
class ProdCatSlider extends \Elementor\Widget_Base
{
    public function get_name()
    {
        return 'prodcatslider';
    }

    public function get_title()
    {
        return esc_html__('Товары по категории', 'smarkets');
    }
...
protected function _register_controls()
{
    ...
    $this->add_control(
        'cat_title1',
        [
            'label' => __('Категория', 'smarkets'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => __('Категория', 'smarkets'),
        ]
    );
...
$settings = $this->get_settings_for_display();
    $args=array(
        ...
        'tax_query' => array( array(
            ...
            'field'    => 'term_id',
            'terms'    => $settings['category-select'],
            'operator' => 'IN',
        ) )
    );
