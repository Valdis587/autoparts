...
class RatingProd extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Товары с отзывами', 'smarkets');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'cat_title1',
            [
                'label' => __('Товары с отзывами', 'smarkets'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Товары с отзывами', 'smarkets'),
            ]
        );
