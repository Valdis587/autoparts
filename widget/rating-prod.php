...
class Rating_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'rating_widget', // Base ID
            esc_html__( 'Товары с отзывами AutoParts', 'smarkets' ), // Name
            array( 'description' => 'A Rating Widget' ) // Args
        );
    }
    ...
    public function form( $instance ) {
        $title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Товары с отзывами', 'smarkets'  );
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Товары с отзывами', 'smarkets'  ); ?></label>
...
function register_rating_widget() {
    register_widget( 'Rating_Widget' );
}
add_action( 'widgets_init', 'register_rating_widget' );