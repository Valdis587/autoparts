    ...
    <div class="product-thumb transition product-item-container">
        ...
        <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12 col-right">
            <div class="right-block">
                ...
                <div style="font-size: 10px; text-align: center; height: 10px;" class="main-rating">
                    <?php
                    global $product;
                ...
                if ($day && $year && $mon) {
                    ?>
                <div id="<?php echo get_the_ID() ?>" class="item-time main-action<?php echo get_the_ID() ?>" data-day='<?php echo $day ?>' data-mon='<?php echo $mon ?>' data-year='<?php echo $year ?>'>
                    <div class="item-timer">
                        <div class="defaultCountdown-<?php echo get_the_ID() ?>"></div>
                    </div>
                </div>
                <?php } ?>
