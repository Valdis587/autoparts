...
$opt_name = 'autopars';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
//--main--//
require get_template_directory() . '/includes/admin/sample/general/typo.php';
Redux::set_section(
    $opt_name,
    array(
...
require get_template_directory() . '/includes/admin/sample/general/search.php';
require get_template_directory() . '/includes/admin/sample/general/seti.php';
require get_template_directory() . '/includes/admin/sample/general/color.php';
require get_template_directory() . '/includes/admin/sample/general/favicon.php';
...
require get_template_directory() . '/includes/admin/sample/header/menu.php';
require get_template_directory() . '/includes/admin/sample/header/logo.php';
require get_template_directory() . '/includes/admin/sample/header/color.php';
...
require get_template_directory() . '/includes/admin/sample/footer/contact.php';
require get_template_directory() . '/includes/admin/sample/footer/menu.php';
require get_template_directory() . '/includes/admin/sample/footer/payment.php';
require get_template_directory() . '/includes/admin/sample/footer/color.php';

Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Блог', 'your-textdomain-here' ),
        'id'               => 'blog',
        'customizer_width' => '400px',
        'icon'             => 'el el-book',
    )
);
require get_template_directory() . '/includes/admin/sample/blog/blog-post.php';
require get_template_directory() . '/includes/admin/sample/blog/color.php';
...
require get_template_directory() . '/includes/admin/sample/shop/banner.php';
require get_template_directory() . '/includes/admin/sample/shop/badges.php';
require get_template_directory() . '/includes/admin/sample/shop/quick.php';
require get_template_directory() . '/includes/admin/sample/shop/catalog.php';
require get_template_directory() . '/includes/admin/sample/shop/color.php';
...
require get_template_directory() . '/includes/admin/sample/404/404.php';
