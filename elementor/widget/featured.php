...
class Featured extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Избранные товары', 'smarkets');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'cat_title1',
            [
                'label' => __('Избранные товары', 'smarkets'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Избранные товары', 'smarkets'),
            ]
        );
