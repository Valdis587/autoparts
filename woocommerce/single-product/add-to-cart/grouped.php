...
<form class=" grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
    ...
    <div class="cart">
		<button type="submit" class="single_add_to_cart_button btn btn-mega btn-lg"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
    </div>
