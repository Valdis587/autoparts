            ...
            <ul id="cat_accordion" class="list-group">
                ...
                if($terms) {
                    foreach($terms as $term) {
                        ...
                        if($children_terms) { ?>
                            <li class="hadchild"><a href="<?php echo get_category_link($term->term_id);?>" class="cutom-parent"><?php echo $term->name;?></a>   <span class="button-view  fa fa-plus-square-o"></span>
                                <ul style="display: block;">
                                    <?php foreach ($children_terms as $children_term) { ?>
                                        <li style="margin-top: 10px"><a  href="<?php echo get_category_link($children_term->term_id);?>"><?php echo $children_term->name; ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } else { ?>
                            <li class=""><a href="<?php echo get_category_link($term->term_id);?>" class="cutom-parent"><?php echo $term->name;?></a>  <span class="dcjq-icon"></span></li>
                        <?php } } } ?>
            </ul>
</div>
</div>
